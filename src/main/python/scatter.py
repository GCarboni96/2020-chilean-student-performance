...
df = pd.read_csv(
    r"D:\\Documentos_U\\2020-1\\Patos\\Proyecto\\chilean-student-performance\\chilean-student-performance\\out\\evaluationyearlyreg\\results.csv",
    sep=';')
...
print("cat 1: {0}, {1}".format(cat_1['codigo_region'].mean() / cat_1['avg_grades'].count(),
                               cat_1['avg_grades'].mean() / cat_1['avg_grades'].count()))
...
print("cat 2: {0}, {1}".format(cat_2['codigo_region'].mean() / cat_2['avg_grades'].count(),
                               cat_2['avg_grades'].mean() / cat_2['avg_grades'].count()))
...
print("cat 3: {0}, {1}".format(cat_3['codigo_region'].mean() / cat_3['avg_grades'].count(),
                               cat_3['avg_grades'].mean() / cat_3['avg_grades'].count()))
