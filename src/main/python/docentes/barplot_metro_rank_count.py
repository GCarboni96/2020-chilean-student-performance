...
df = pd.read_csv(r"D:\\Documentos_U\\2020-1\\Patos\\Proyecto\\chilean-student-performance\\out\\docentes\\comunasmetropolitana\\results-docentes-comuna.csv", sep = ';')
...
plt.title("Cantidad Clasificaciones docentes por comunas de Santiago (2013-2018)")
